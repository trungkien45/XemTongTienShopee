			...
			if(next > 0) {
				...
				orders.forEach(order => {
					...
					if(t31 > tongChuaGiamTrongDon){
						...
						console.log("%ctổng tiền hàng: "+"%c" + pxgPrice(tongChuaGiamTrongDon), "font-size:26px;","font-size: 20px; color:green");
						console.log("%ctổng tiền hàng + số tiền phí - trừ voucher: " +"%c" + pxgPrice(t31), "font-size:26px;", "font-size: 20px; color:green");
						console.log("%csố tiền hớ: "+"%c" + pxgPrice(tongChuaGiamTrongDon - t31), "font-size:26px;","font-size: 20px; color:green");
					}
