			...
			if(next > 0) {
				...
				orders.forEach(order => {
					...
					if(t31 > tongChuaGiamTrongDon){
						...
						console.log("%c tổng tiền hàng: "+"%c" + pxgPrice(tongChuaGiamTrongDon), "font-size:10px;","font-size: 20px; color:green");
						console.log("%c tổng tiền hàng + số tiền phí - trừ voucher: " +"%c" + pxgPrice(t31), "font-size:10px;", "font-size: 20px; color:green");
						console.log("%c số tiền hớ: "+"%c" + pxgPrice(tongChuaGiamTrongDon - t31), "font-size:10px;","font-size: 20px; color:green");
					}
